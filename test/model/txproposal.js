...
describe('TxProposal', function() {
  ...
  describe('#getBitcoreTx', function() {
    it('should create a valid litecore TX', function() {
      var txp = TxProposal.fromObj(aTXP());
  ...
  describe('#getRawTx', function() {
    it('should generate correct raw transaction for signed 2-2', function() {
      ...
      txp.getRawTx().should.equal(newRawTx);//theRawTx);
    });
  });
...
var theSignatures = ['30460221009b958f8078b410bb8e4671202bde171f4bca87bdc516cffe71b1a14d298293520221008508a68c912b91c6484ed9c7f033d751ec41b3b31315590c9be8cb26bc3748d1'];
